...
def main():
    ...
    parser.add_argument(
        "--cache_dir", type=str, default=None, help="cache dir containing *.fst"
    )
    ...
    parser.add_argument(
        "--traditional_to_simple", type=str, default="True", help='i.e., "喆" -> "哲"'
    )
    parser.add_argument(
        "--remove_puncts",
        type=str,
    ...
    parser.add_argument(
        "--full_to_half", type=str, default="True", help='i.e., "Ａ" -> "A"'
    )
    parser.add_argument(
        "--tag_oov", type=str, default="False", help='tag OOV with "OOV"'
    )
    parser.add_argument(
        "--language",
        type=str,
        default="zh",
        choices=["zh", "en", "ja", "yue"],
        help="valid languages (add 'yue' for Cantonese)",
    )
    ...
    if args.language == "zh":
        ...
        # Cantonese/Terrain (yue) — use OpenCC s2hk conversions for Cantonese-preferred Traditional forms

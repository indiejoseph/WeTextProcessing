...
class Date(Processor):
    ...
    def build_tagger(self):
        ...
        m = string_file(get_abs_path("cantonese/data/date/m.tsv"))
        mm = string_file(get_abs_path("cantonese/data/date/mm.tsv"))
        d = string_file(get_abs_path("cantonese/data/date/d.tsv"))
        dd = string_file(get_abs_path("cantonese/data/date/dd.tsv"))

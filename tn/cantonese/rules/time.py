...
class Time(Processor):
    ...
    def build_tagger(self):
        h = string_file(get_abs_path("cantonese/data/time/hour.tsv"))
        m = string_file(get_abs_path("cantonese/data/time/minute.tsv"))
        s = string_file(get_abs_path("cantonese/data/time/second.tsv"))
        noon = string_file(get_abs_path("cantonese/data/time/noon.tsv"))
        colon = delete(":") | delete("：")
